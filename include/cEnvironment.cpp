...
namespace DoI
{
    cEnvironment::cEnvironment(cConstants * constants, double time_step, uint64_t space_division):
    m_constants(constants), m_time_step(time_step), m_space_division(space_division),
    m_time(0), m_backup_time(0)
    {
    ...
    {
        return 5;   //TODO =], get voltage from scenario parser.
    }
